...
const SHADOW_ASSET_VERSION = '1.20.1';
...
<script src="/js/shadow-graph.js?v=${SHADOW_ASSET_VERSION}" defer></script>
...
<script src="/js/shadow-settings.js?v=${SHADOW_ASSET_VERSION}" defer></script>
